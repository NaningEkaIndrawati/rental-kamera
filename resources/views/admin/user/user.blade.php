                    ...
                    <table id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->alamat }}</td>
                                <td>{{ $item->telepon }}</td>
                                <td><a class="btn btn-success" href="{{ route('admin.buatreservasi',['penyewaId' => $item->id]) }}">Buat Reservasi</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            <div class="modal-body">
                <form action="{{ route('user.new') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-2">
                        <input type="text" name="nama" class="form-control" id="floatingName" placeholder="Nama" required>
                        <label for="floatingName">Nama Lengkap</label>
                    </div>
                    <div class="form-floating mb-2">
                        <input type="text" name="alamat" class="form-control" id="floatingInput" placeholder="Alamat Lengkap" required>
